...
#undef org_voltdb_jni_ExecutionEngine_ERRORCODE_SUCCESS_MORE_DATA
#define org_voltdb_jni_ExecutionEngine_ERRORCODE_SUCCESS_MORE_DATA 3L
...
/*
 * Class:     org_voltdb_jni_ExecutionEngine
 * Method:    nativeExtractTable
 * Signature: (JI[BJJJII)I
 */
JNIEXPORT jint JNICALL Java_org_voltdb_jni_ExecutionEngine_nativeExtractTable
  (JNIEnv *, jobject, jlong, jint, jbyteArray, jlong, jlong, jlong, jint, jint);

/*
 * Class:     org_voltdb_jni_ExecutionEngine
 * Method:    nativeUpdateExtractRequest
 * Signature: (JIZ)I
 */
JNIEXPORT jint JNICALL Java_org_voltdb_jni_ExecutionEngine_nativeUpdateExtractRequest
